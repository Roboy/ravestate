...
def test_property_push_pop(mocker, context_wrapper_fixture, context_with_property_fixture):
    with mocker.patch.object(context_with_property_fixture, 'emit'):
        ...
        context_with_property_fixture.emit.assert_called_with(s(f"{DEFAULT_PROPERTY_FULLNAME}:pushed"))
        ...
        context_with_property_fixture.emit.assert_called_with(s(f"{CHILD_PROPERTY_FULLNAME}:changed"))
        ...
        context_with_property_fixture.emit.assert_called_with(s(f"{DEFAULT_PROPERTY_FULLNAME}:popped"))
...
def test_property_nested(mocker, context_wrapper_fixture, context_with_property_fixture):
    with mocker.patch.object(context_with_property_fixture, 'emit'):
        ...
        context_with_property_fixture.emit.assert_called_with(s(f"{CHILD_PROPERTY_FULLNAME}:pushed"))
        ...
        context_with_property_fixture.emit.assert_called_with(s(f"{GRANDCHILD_PROPERTY_FULLNAME}:changed"))
...
def test_property_nested_2(mocker, context_wrapper_fixture, context_with_property_fixture):
    with mocker.patch.object(context_with_property_fixture, 'emit'):
        ...
        context_with_property_fixture.emit.assert_called_with(s(f"{CHILD_PROPERTY_FULLNAME}:popped"))
