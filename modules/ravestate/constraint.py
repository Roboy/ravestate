...
def s(signal_name: str, *, min_age=0, max_age=10, detached=False):
    """
    ...
    :param detached: Flag which indicates, whether spikes that fulfill this signal
...
class Signal(Constraint):
    ...
    def __init__(self, name: str, *, min_age=0, max_age=10, detached=False):
        self.name = name
